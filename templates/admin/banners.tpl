        ...
        <div class="wrap-group">
                ...
                <div class="col col-lg-4">
                    <select name="position" id="js-banner-position">
                        {foreach $positions as $position}
                            <option value="{$position.id}" data-width="{$position.width}"
                                ...
                                {$position.position}
                                : {if $position.title}{$position.title}{else}{lang key='without_title'}{/if}
                                ({$position.bn_col}/{$position.bn_max})
                            </option>
                        {/foreach}
                    </select>
                </div>
            ...
            <div class="row" id="uploadcontainer" style="display: none;">
                <label class="col col-lg-2 control-label"
                       for="file">{lang key='choose_file_upload'} {lang key='field_required'}</label>
                <div class="col col-lg-4">
            ...
            <div class="row">
                <label class="col col-lg-2 control-label"
                       for="banner-title">{lang key='banner_title'} {lang key='field_required'}</label>
                <div class="col col-lg-4">
            ...
            <div class="field_type" id="bannerurl" style="display: none;">
                ...
                <div class="row">
                    ...
                    <div class="col col-lg-4">
						...
						<input type="text" name="targetframe" class="common"
                               value="{if $item.target}{$item.target}{else}_blank{/if}">
					</span>
                    </div>
                </div>
            </div>
